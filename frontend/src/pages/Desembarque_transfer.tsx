...
const DesembarqueTransfer: React.FC = () => {
    ...
    const t = (key: string) => {
        const translations: Record<string, Record<string, string>> = {
            'pt-br': {
                'conferenceForDisembarkation': 'CONFERÊNCIA PARA DESEMBARQUE:',
                'request': 'REQUISIÇÃO',
            ...
            'en': {
                'conferenceForDisembarkation': 'Conference For Disembarkation:',
                'request': 'REQUEST',
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        setForm((prev) => {
            ...
            if (name === "conf_QuantidadeConferida") {
                ...
                const sol = Number(updated.QuantityToBeTransferred_QuantidadeATransferir || 0);
                const ativar = !Number.isNaN(conf) && !Number.isNaN(sol) && conf !== sol; // ativar apenas quando diferentes
    ...
    return (
        <div className="page-container">
            <PageHeader
                ...
                buttons={[
                  { label: t('backToDisembarkment'), onClick: () => navigate('/desembarque'), className: 'btn-secondary' }
                ]}
            />

            <div className="filter-section">
                <div style={{ marginBottom: "20px" }}>
                    <h3 className="section-title"><CardIcon type="filtro-busca" className="section-icon" /> {t('conferenceForDisembarkation')} </h3>
                </div>
                ...
                <div className="item-info-layout">
                    ...
                    {/* Motivo da Divergência (apenas quando as quantidades forem diferentes) */}
                    {showMotivoPadrao && (
                        <div className="item-row">
                            <div className="form-group">
