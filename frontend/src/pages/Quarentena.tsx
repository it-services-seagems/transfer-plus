...
import { faShieldAlt, faSearch, faList } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="page-container">
      ...
      <section className="results-section">
        <h2 className="section-title"><span className="section-icon"><FontAwesomeIcon icon={faList} /></span> {t('results')} ({resultados.length})</h2>
