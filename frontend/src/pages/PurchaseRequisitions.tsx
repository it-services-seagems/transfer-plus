  ...
  return (
    <div className="page-container">
      <PageHeader
        ...
        icon={<FontAwesomeIcon icon={faFileInvoiceDollar} className="section-icon" />}
      ...
      <section className="filter-section">
        <h2 className="section-title"><span className="section-icon"><FontAwesomeIcon icon={faSearch} /></span>{t('searchFilters')}</h2>
      ...
      .results-controls-top {
        ...
        .page-container {
          padding: var(--page-header-height, 72px) 24px 64px 24px;
          min-height: 100vh;
        }
        ...
        .language-selector .language-btn.active {
          background: linear-gradient(90deg, #073776 0%, #ffffff 100%);
        }
      `}</style>
