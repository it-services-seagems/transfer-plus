...
import { faTruckLoading, faSearch, faList } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="page-container">
      ...
      >
        ...
        <div className="filter-grid">
          ...
          {renderSmartSearch("SPN", `${t('SPN')}`, spnSearchValue, filteredSpnOptions, handleSpnChange, selectSpnOption)}
      ...
      <section className="results-section">
        <h2 className="section-title">
          <span className="section-icon"><FontAwesomeIcon icon={faList} /></span>
            ...
            data.map(row => (
              <div key={row.id} className="result-item">
                ...
                <div className="result-details">
                  ...
                  <div className="detail-item">
                    <div className="detail-label">{t('lom')}</div>
